...
func DefaultConfig() Config {
	return Config{
		...
		TargetSuccessBids:      15000,
		TargetMatchedBilling:   12000,
		TargetUnknownBilling:   1000,
		TargetDuplicateBilling: 1000,
		TargetNoFillRequests:   1000,
		TargetInvalidBilling:   200,
